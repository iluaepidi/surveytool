...
@Path("/OptionMatrixService")
public class OptionMatrixService {
	...
	@Consumes(MediaType.TEXT_PLAIN)
	@Produces(MediaType.TEXT_PLAIN)
    public String deleteOption(@PathParam("param") String optionMatrixId) {
    	System.out.println("Opción (delete): " + optionMatrixId);
    	
    	String response = "false";
    	
    	OptionHandler optionHandler = new OptionHandler();
    	response = String.valueOf(optionHandler.removeOptionMatrix(Integer.parseInt(optionMatrixId)));
