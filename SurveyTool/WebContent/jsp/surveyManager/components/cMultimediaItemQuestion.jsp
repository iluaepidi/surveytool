    ...
    pageEncoding="ISO-8859-1"%>
							  					...
							  					%>
							  							<li class="multimedia-item" rid="<%= resource.getResourceId() %>">
							  								...
							  								<button id="removeMultimediaFile" class="btn btn-transparent red" aria-label="<%= lang.getContent("button.remove_file") %>: <%= title %>"><i class="fa fa-trash" aria-hidden="true"></i></button>
							  								<%} %>
												...
												<%
							  					...
							  					%>
							  							<li class="multimedia-item" rid="<%= resource.getResourceId() %>">
							  								...
							  								<% if((boolean)request.getAttribute(Attribute.s_ADD_QUESTIONS)){ %>
							  								<button id="removeMultimediaFileQuestion" class="btn btn-transparent red" aria-label="<%= lang.getContent("button.remove_video") %>: <%= title %>"><i class="fa fa-trash" aria-hidden="true"></i></button>
							  								<%} %>
