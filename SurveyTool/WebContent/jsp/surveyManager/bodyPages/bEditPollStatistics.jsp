...
<div class="container-fluid">
	...
	<div class="title-content-no-underline">
		<h2 id="title-header-edit"><a href="InitialServlet"><%= lang.getContent("user_panel.title") %></a> > <a href="UserPanelHomeServlet?upoption=surveys&tab=poll"><%= lang.getContent("survey_manager.title") %></a> > <%= lang.getContent("survey.statistic.title") %></h2>
		<div class="right">
			<ul class="nav nav-tabs nav-tabs-right nav-tab-edit">
			  	...
			  	<li role="presentation" class="share-tab" id="share-tab"><a href="pollcode?pid=<%= poll.getPublicUrl() %>" title="<%= lang.getContent("survey.edit.tab.go_edit") %>"><i class="fa fa-users fa-2x" aria-hidden="true"></i></a></li>						  	
			  	<li role="presentation" class="statistic-tab active" id="statistic-tab"><a href="#" aria-label="<%= lang.getContent("survey.edit.tab.go_statistics") %>" title="<%= lang.getContent("survey.edit.tab.go_statistics") %>" id="tab-display-statistics"><i class="fa fa-bar-chart fa-2x" aria-hidden="true"></i></a></li>
			</ul>
		</div>
	</div>
