...
<div class="container-fluid">
	...
	<div class="title-content-no-underline">
		...
		<ul class="nav nav-tabs nav-tabs-right nav-tab-edit">						  	
		  	...
		  	<li role="presentation" class="share-tab" id="share-tab"><a href="pollcode?pid=<%= poll.getPublicUrl() %>" title="<%= lang.getContent("survey.edit.tab.go_edit") %>"><i class="fa fa-users fa-2x"></i></a></li>
