					...
					<div class="title-content-no-underline">
	  					...
	  					<div class="right">
		  					<ul class="nav nav-tabs nav-tabs-right nav-tab-edit">
							  	...
							  	<li role="presentation" class="share-tab active" id="share-tab"><a href="#" title="<%= lang.getContent("poll.edit.tab.go_share") %>"><i class="fa fa-users fa-2x" aria-hidden="true"></i></a></li>		
	  				...
	  				<div class="content-box-tabs edit-content">
	  					<div class="code-poll-frame">
  							...
  							<p class="poll-preview-notice"><%= lang.getContent("poll.preview.notice") %></p>
