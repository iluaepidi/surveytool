	  				...
	  				<div class="title-content-no-underline">
	  					...
	  					<div class="right">
		  					<ul class="nav nav-tabs nav-tabs-right nav-tab-edit">
							  	...
							  	<li role="presentation" class="share-tab active" id="share-tab"><a href="SurveysFees?surveyid=<%=survey.getSurveyId() %>" title="<%= lang.getContent("survey.edit.tab.go_edit") %>"><i class="fa fa-users fa-2x" aria-hidden="true"></i></a></li>
