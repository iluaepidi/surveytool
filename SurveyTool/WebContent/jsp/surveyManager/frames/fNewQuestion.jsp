...
%>	
				...
				<div class="modal fade survey-win" id="newQuestionModal" tabindex="-1" role="dialog" aria-labelledby="newQuestionTitle">
					<div class="modal-dialog survey-win-dialog" role="document">
				    	<div class="panel panel-primary"> 
				    		<div class="panel-heading"> 
				    			...
				    			<h2 class="panel-title" id="newQuestionTitle"><%= lang.getContent("question.new.title") %></h2> 
				    		</div> 
				    		<div class="panel-body">
				    			<fieldset class="survey-frame">
									...
									<ul class="row qtype-list">
										...
										<!-- <li class="col-sm-1 center btn-qtype">
											<button class="btn-transparent" id="grading"><i class="fa fa-sort-numeric-asc fa-2x btn btn-default" aria-hidden="true"></i> <span class="qtype-icon-text"><%=lang.getContent("question.new.grading")%></span></button>
										</li> -->
										<li class="col-sm-1 center btn-qtype">
											<button class="btn-transparent" id="matrix"><i class="fa fa-th fa-2x btn btn-default" aria-hidden="true"></i> <span class="qtype-icon-text"><%=lang.getContent("question.new.matrix")%></span></button>
										</li>
										<li class="col-sm-1 center btn-qtype">
											<button class="btn-transparent" id="scale"><i class="fa fa-th fa-2x btn btn-default" aria-hidden="true"></i> <span class="qtype-icon-text"><%=lang.getContent("question.new.scale")%></span></button>
										</li>
										<!--  <div class="col-sm-1 center btn-qtype">
											<a id="code"><i class="fa fa-file-code-o fa-2x btn btn-default" aria-hidden="true"></i> <span class="qtype-icon-text"><%= lang.getContent("question.new.code")%></span></a>
										</div>--> 
									</ul>
				    			</fieldset>
				    					...
				    					<form>
											...
											<div class="col-md-5 basic-settings-right-options">
												<div class="div-create-question-mandatory row">
													<label for="mandatory" class="col-md-5 col-sm-3 col-xs-3" ><i class="fa fa-asterisk red" aria-hidden="true"></i><span><%= lang.getContent("question.mandatory") %></span></label>
