		...
		<fieldset>
			...
			<div class="form-question-content">
				...
				<ul class="form-options">
				 	<li class="checkbox" ng-class="{img: hasResource(question.optionsGroups[0].options), fourImg: question.optionsGroups[0].options.length == 4}" ng-repeat="option in question.optionsGroups[0].options">
					  ...
					  <div class="form-question-content other-option-text-div" ng-if="option.otherOption">
						...
						<textarea class="form-control other-option-text" 
							...
							ng-focus="setOtherMultipleFocus(option)" ng-readonly="option.response == false"
							ng-model="option.responseOtherText"></textarea>
					  </div>
					</li>
