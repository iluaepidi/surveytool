				...
				<div class="form-question-content">
					<div class="likert-options">
					 ...
					 <div class="likert-legend clearfix nopadding">
					 	<div class="col-sm-1 col-xs-1" ng-repeat='n in [] | range:getNumber(11)'>{{getContentElementByAttrAndIndex(question.contents, "contentType", "label", n - getLabelPointDisp(getNumber(getJsonArrayElement(question.parameters, "name", "scaleType").value))).text || ""}}</div>
