										...
										<div class="panel-question" id="panel-question1" qid="<%= question.getQuestionId() %>">
											...
											<div class="panel-body">									
							  					<div class="panel-question-basic-setting row">
													...
													<div class="col-md-2">
														<button class="btn" selected="<%= question.isHelpText() %>" id="helpTextButton" data-toggle="modal" data-target="#setHelpText"><i class="fa fa-question-circle fa-2x"></i><span>Help text</span></button>
													</div>
													<div class="col-md-2">
