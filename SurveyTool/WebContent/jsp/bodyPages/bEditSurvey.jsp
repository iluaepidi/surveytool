...
<%@page import="ilu.surveytool.constants.Attribute"%>
				...
				<div class="container-fluid">
	  				<div class="title-content-no-underline">
	  					<h2><a href="InitialServlet">User Panel</a> > <a href="UserPanelHomeServlet?upoption=surveys">Survey Manager</a> > Edit Survey</h2>
	  					<ul class="nav nav-tabs nav-tabs-right nav-tab-edit">						  	
						  	...
						  	<li role="presentation" class="edit-tab active"><a href="#" aria-label="go to edit survey" title="go to edit survey"><i class="fa fa-pencil-square-o fa-2x"></i></a></li>
						</ul>
	  				</div>
	  				<div class="content-box-tabs edit-content">
	  					...
	  					<div class="edit-content-center">
		  					...
		  					<div class="edit-survey-frame survey-info" id="survey-info" sid="<%= survey.getSurveyId() %>">
		  						...
		  						<input type="text" class="survey-info-title" id="survey-info-title" aria-label="Survey title" value="<%= survey.getContents().get(DBConstants.s_VALUE_CONTENTTYPE_NAME_TITLE).getText() %>" />
								...
								<div class="survey-info-url">
									<label for="clipboard-text" class="col-sm-3 control-label left">Survey URL: </label>
							   		<div class="col-sm-8">
							   		...
							   		<button class="col-sm-1 btn-transparent btn-copy-clipboard" id="target-to-copy" data-clipboard-target="clipboard-text" title="Copy URL to clipboard" aria-label="Copy survey URL to clipboard"><i class="fa fa-clipboard fa-2x"></i></button>
								</div>
		  					</div>	
			  					...
			  					<div class="panel-section" id="panel-section1">
									...
									<div class="page" id="page" pid="<%= pageId %>">
										...
										<div class="panel-body" id="panel-body">									
					  						...
					  						<div class="add-menu-frame" id="add-menu-frame">
						  						<div class="col-sm-5 add-vacio"></div>
					  							<a class="btn-add col-sm-2" href="#btn-question" aria-label="Add new content" title="create new content"><i class="fa fa-plus-circle fa-2x"></i></a>
					  							<div class="col-sm-5 add-menu">
					  								<div class="col-sm-1">...</div>
					  								<div class="btn-group col-sm-11" role="group" aria-label="...">
														<button type="button" class="btn btn-add-menu" id="btn-question" data-toggle="modal" data-target="#newQuestionModal">Question</button>
