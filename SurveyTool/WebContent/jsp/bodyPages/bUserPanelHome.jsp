	  				...
	  				<div class="content">
	  					...
	  					<div class="user-panel-menu">
		  					<ul class="row row-menu">
		  						<li class="col-md-3 center"><a href="<%= Address.s_SERVLET_USER_PANEL_HOME + "?" + FormParameter.s_UPOPTION + "=" + Address.s_BODY_SURVEYS %>"><i class="fa fa-list-alt fa-5x"></i><div>Survey</div></a></li>
