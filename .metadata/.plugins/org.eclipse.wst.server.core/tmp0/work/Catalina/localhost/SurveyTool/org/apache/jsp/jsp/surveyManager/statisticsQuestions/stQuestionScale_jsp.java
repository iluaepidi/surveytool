...
public final class stQuestionScale_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List<OptionsByGroup> obg = sQ.getOptionsByGroup();
      ...
      out.write(',');
      out.write(' ');
      out.print( Math.round(((((numResponses)*1.0)/(sQ.getNumResponses()*1.0))*100.0)*100.0)/100.0);
      out.write("\r\n");
      out.write("    \t\t    \t\t");
      ...
      out.write("\t\t              \t\t<canvas id=\"myChartScale");
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t  var data = {\r\n");
      out.write("\t\t\t\t\t\t\t\t    labels: [1,2,3,4,5,6,7],\r\n");
      out.write("\t\t\t\t\t\t\t\t    datasets: [\r\n");
      out.write("\t\t\t\t\t\t\t\t      {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t  var ctx = document.getElementById(\"myChartScale");
      out.print( question.getQuestionId() );
      out.write("\").getContext(\"2d\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t  var myChartScale = new Chart(ctx).Bar(data);\r\n");
      out.write("\t\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t            \t</div>\r\n");
      out.write("\t          \t</div>\t      \t\r\n");
