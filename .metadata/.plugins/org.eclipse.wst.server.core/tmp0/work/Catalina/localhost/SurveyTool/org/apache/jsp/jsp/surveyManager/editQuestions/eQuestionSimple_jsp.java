...
public final class eQuestionSimple_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    <option value=\"s\" selected>");
      out.print(lang.getContent("question.new.simple"));
      out.write("</option>\r\n");
 ...
 if((boolean)request.getAttribute(Attribute.s_ADD_QUESTIONS)){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"other-option-");
      out.print( question.getIndex() );
      out.write('"');
      out.write('>');
      out.print(lang.getContent("question.form.options.other"));
      out.write("</label>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t  \t\t\t\t\t\t\t<textarea class=\"form-control\" id=\"survey-question-other-text\" rows=\"1\" placeholder=\"");
      out.print( lang.getContent("placeholder.type_label") );
      out.write("\" aria-label=\"");
      out.print( lang.getContent("question.edit.description.aria_label") );
 ...
 if((boolean)request.getAttribute(Attribute.s_ADD_QUESTIONS)){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "eqComponents/eqDependences.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("withLogic", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("true", request.getCharacterEncoding()), out, false);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
} 
      out.write("\t\t\t\t\t\t  \t\t\t\t\t\t\t  \t\t\t\t\t\r\n");
