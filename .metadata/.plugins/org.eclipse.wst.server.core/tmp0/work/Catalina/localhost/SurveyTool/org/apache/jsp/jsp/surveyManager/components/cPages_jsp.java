...
public final class cPages_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Section section = (Section) request.getAttribute(Attribute.s_SECTION);
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<ul class=\"section-pages\" id=\"section-pages\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "cPage.jsp", out, false);
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
