...
public final class eqDescription_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t  \t\t\t\t\t<div class=\"row\" type=\"global\" id=\"question-frame-help\">\r\n");
      out.write("\t\t\t\t\t\t\t  \t\t\t\t\t\t<label>");
      out.print( lang.getContent("question.edit.description.title") );
      out.write("</label>\r\n");
      out.write("\t\t\t\t\t\t\t  \t\t\t\t\t\t<textarea class=\"form-control\" id=\"survey-question-description-text\" rows=\"2\" placeholder=\"");
