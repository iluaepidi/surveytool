 ...
 * Generated at: 2016-10-07 08:38:29 UTC
...
public final class eQuestionLongText_jsp extends org.apache.jasper.runtime.HttpJspBase
...
lang.loadLanguage(Language.getLanguageRequest(request));
      ...
      out.write("</option>\r\n");
      out.write("\t\t\t\t\t<option value=\"p\" selected>");
      out.print(lang.getContent("question.new.paragraph"));
      out.write("</option>\r\n");
 ...
 if((boolean)request.getAttribute(Attribute.s_ADD_QUESTIONS)){ 
      ...
      out.write("\t\t\t\t<label>");
      out.print(lang.getContent("question.long.chars"));
      out.write("</label>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t\t\t\t\r\n");
      out.write("  \t\t\t\t<div class=\"question-response-settings\" id=\"genericOptions\">\r\n");
...
if(!textLength.equals("")){
      ...
      out.print(lang.getContent("question.long.chars.label") );
      out.write("</label>\r\n");
 ...
 if(textLength.equals("")){ 
      ...
      out.write("\t\t\t<div class=\"row\" type=\"global\">\r\n");
      out.write("\t\t\t\t<label>");
      out.print(lang.getContent("question.long.lines"));
      out.write("</label>\r\n");
      out.write("\t\t\t\t<div class=\"question-response-settings\">\r\n");
      out.write("\t\t\t\t\t<input class= \"question-response-settings-options\" type=\"radio\" name=\"lines-");
      out.print( question.getIndex() );
      out.write("\" id=\"adjust-lines-adjust\" value=\"adjusted\" ");
if(lines.equals("")){
      out.write(" checked ");
}
      out.write(">\r\n");
      out.write("  \t\t\t\t\t<label class= \"question-response-settings-options\" for=\"adjust-lines-adjust\">");
      out.print(lang.getContent("question.long.lines.numberChars"));
      out.write("</label>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"question-response-settings\">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t\t\t\t\r\n");
      out.write("  \t\t\t\t\t<input class= \"question-response-settings-options\" type=\"radio\" name=\"lines-");
      out.print( question.getIndex() );
      out.write("\" id=\"adjust-lines-set\" value=\"set\" ");
if(!lines.equals("")){
      out.write(" checked ");
}
      out.write(">\r\n");
      out.write("  \t\t\t\t\t<label class= \"question-response-settings-options\" for=\"adjust-lines-set\">");
      out.print(lang.getContent("question.long.lines.set"));
      out.write("</label>\r\n");
 ...
 if(lines.equals("")){ 
      ...
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"number\" min=\"0\" max=\"9999\" onkeydown=\"limit(this)\" onkeyup=\"limit(this)\" id=\"survey-question-max-lines\" value=\"");
      out.print( lines );
      out.write("\"></input>\r\n");
      out.write(" \t\t\t\t\t\t<label for=\"survey-question-max-lines\">");
      out.print(lang.getContent("question.long.lines.set.type"));
      out.write("</label>\r\n");
      out.write("  \t\t\t\t\t</div>\r\n");
      out.write("  \t\t\t\t</div>\r\n");
      out.write("  \t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\t \r\n");
