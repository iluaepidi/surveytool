...
public final class stQuestionMultiple_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List<Option> o = sQ.getOptions();
 ...
 for(int i = 0; i<o.size();i++){
      ...
      out.write(',');
      out.write(' ');
      out.print( Math.round((((((OptionsByGroup)(obg.get(j))).getNumResponses()*1.0)/(sQ.getNumResponses()*1.0))*100.0)*100.0)/100.0);
      out.write("\r\n");
      out.write("\t\t        \t\t    \t\t\t\t");
}
		        		    		}
      ...
      out.write("\t\t              \t\t<canvas id=\"myChartMultiple");
      ...
      out.write("\t\t\t\t\t\t\t\t  var ctx = document.getElementById(\"myChartMultiple");
      out.print( question.getQuestionId() );
      out.write("\").getContext(\"2d\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t  var myChartMultiple = new Chart(ctx).Bar(data);\r\n");
      out.write("\t\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t            \t</div>\r\n");
      out.write("\t          \t</div>\t      \t\r\n");
