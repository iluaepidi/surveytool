	  					...
	  					<div class="user-panel-surveys">
		  					...
		  					<div class="surveys-table">
		  						<table class="table table-bordered" sumary="List of surveys where ...">
									...
									<tr>
										<td class="center">10 days left</td>
										<td><a href="#">SURVEY ON TURISM HABITS FORM PEOPLE WITH DISABILITIES</a></td>
										<td>
											<div class="progress percent-bar">
												<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 80%;">80/100</div>
											</div>
										</td>
										<td>
											<ul class="row">
									...
									<tr>
										<td class="center">23 days left</td>
										<td><a href="#">SURVEY ON EMPLOYMENT OPORTUNITIES</a></td>
										<td>
											<div class="progress percent-bar">
												<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 40%;">64/160</div>
											</div>
										</td>
										<td>
											<ul class="row">
									...
									<tr>
										<td class="center">28 days left</td>
										<td><a href="#">SURVEY ON EDUCATIONAL EXPERIENCES</a></td>
										<td>
											<div class="progress percent-bar">
												<div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 89%;">178/200</div>
											</div>
										</td>
										<td>
											<ul class="row">
									...
									<tr>
										...
										<td><a href="#">SURVEY ON ACCESSIBILITY BARRIERS</a></td>
										<td>
											<div class="progress percent-bar">
												<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">125/125</div>
											</div>
										</td>
										<td>
											<ul class="row">
